import { Tabulator, SelectRowModule, SortModule, FormatModule, TooltipModule, EditModule } from 'tabulator-tables';
...
Tabulator.registerModule([ SelectRowModule, SortModule, FormatModule, TooltipModule, EditModule ]);
