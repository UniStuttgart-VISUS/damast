import { Tabulator, SelectRowModule, SortModule, FormatModule, TooltipModule } from 'tabulator-tables';
...
Tabulator.registerModule([ SelectRowModule, SortModule, FormatModule, TooltipModule ]);
