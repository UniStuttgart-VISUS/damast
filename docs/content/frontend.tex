...
For places with no position, the \verb!geometry! attribute is set to \verb!null!, as suggested in section 3.2 of RFC~7946\footnote{\url{https://www.rfc-editor.org/rfc/rfc7946\#section-3.2}}.
The \emph{location confidence} of these places is also \verb!null!.
