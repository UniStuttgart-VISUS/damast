...
\begin{tikzpicture}
  ...
  \begin{scope}[xshift=-6cm]
    ...
    \begin{scope}[yshift=11.625cm]
      ...
      \pic (source) at (4,0)
      {table=source/{{name},{source\_type\_id},{default\_confidence}}/3};
      ...
      \pic (annotation_suggestion_document_state) at (4,-2.125)
  ...
  \begin{scope}[xshift=24cm]
    ...
    \begin{scope}[yshift=9cm]
      ...
      \pic (place_time_range) at (4,4)
      { table=place\_time\_range/{{place\_id},{timespan}}/2 };
      ...
      \draw [myarrow] (place_time_range-1-w) -- ++(-0.5,0) |- (place-id-e);
    ...
    \begin{scope}[yshift=2.625cm]
      ...
      \draw [myarrow] (religion-3-e) -- ++(0.3,0) |- (religion-id-e);
    \end{scope}
