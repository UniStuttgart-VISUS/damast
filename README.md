...
A different subset of tiles, or the entire set (ca. 200GB), can be downloaded using the scripts provided in the [GitHub repository associated with the DaRUS repository](https://zenodo.org/doi/10.5281/zenodo.10518202).