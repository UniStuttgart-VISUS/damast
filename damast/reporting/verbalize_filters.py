...
def verbalize(filters, cursor):
    ...
    verbs.append(_verbalize_confidence(filters['confidence'],
        'location_confidence',
        'The location confidence of the location attributed to the piece of evidence',
        cursor))

    verbs.append(_verbalize_confidence(filters['confidence'],
        'place_attribution_confidence',
        'The place attribution confidence of the place attributed to the piece of evidence',
        cursor))
